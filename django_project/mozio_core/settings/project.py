...
try:
    from mozio_core.settings.project import *
except ImportError:
    pass
...
try:
    ...
    # we bring our custom template context_processors into here i.e
        # 'mozio.context_processor.custom_navbar_url'
    ]
except KeyError:
    TEMPLATES = [
        {
...
PIPELINE = {
    'STYLESHEETS': {
        'healthyriver-base': {
            ...
            'output_filename': 'css/mozio-base.css',
            'extra_content': {
...
# ACCOUNT_ADAPTER = 'mozio.adapters.account_adapter.AccountAdapter'
