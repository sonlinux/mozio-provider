...
# os.environ["DJANGO_SETTINGS_MODULE"] = "mozio_core.settings"
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "mozio_core.settings.prod_docker")

# This application object is used by any WSGI server configured to use this
# file. This includes Django's development server, if the WSGI_APPLICATION
# setting points here.

# Customised by Alison so we can access env vars set in apache
