...
then
    ...
    rsync -L  backups/latest.dmp dev.em3.com:/home/docker-mozio/deployment/backups/
    rsync -r -v media/ dev.em3.com:/home/docker-mozio/deployment/media
	...
	ssh dev.em3.com "cd /home/docker-mozio/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
